                    ...
                    <form class="panel needs-validation" method="POST" action="{{ route('student.store') }}" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="district" name="district" required>
                                    ...
                                    <option value="2" {{ old('district',$student->district) == '2' ? 'selected' : '' }}>Chattogram</option>
                                    <option value="3" {{ old('district',$student->district) == '3' ? 'selected' : '' }}>Rajshahi</option>
                                    <option value="4" {{ old('district',$student->district) == '4' ? 'selected' : '' }}>Khulna</option>
                                    <option value="5" {{ old('district',$student->district) == '5' ? 'selected' : '' }}>Barishal</option>
                                    <option value="6" {{ old('district',$student->district) == '6' ? 'selected' : '' }}>Sylhet</option>
                                    <option value="7" {{ old('district',$student->district) == '7' ? 'selected' : '' }}>Rangpur</option>
                                    <option value="8" {{ old('district',$student->district) == '8' ? 'selected' : '' }}>Mymensingh</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="subjects[]" value="English"
                                        id="english" {{ in_array('English', old('subjects', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="subjects[]" value="Science"
                                        id="science" {{ in_array('Science', old('subjects', [])) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex flex-wrap justify-content-end gap-2 mt-4"><a class="btn btn-outline-secondary"
                                href="users.html">Cancel</a><button class="btn btn-primary" type="submit"><i
                                    class="bi bi-person-check" aria-hidden="true"></i>Update User</button></div>
                    </form>
                </div>
            </section>
        </div>
