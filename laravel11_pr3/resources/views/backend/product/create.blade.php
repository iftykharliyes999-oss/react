                ...
                <div class="card">
                   <div class="card-body">
                     <div class="mb-4">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="write title here....">
                     </div>
                     <div class="mb-4">
                     ...
                     <div class="mb-4">
                        ...
                        <input name="price" type="text" class="form-control" placeholder="write price here....">
                     </div>
                     <div class="mb-4">
                      <h5 class="mb-3">Display images</h5>
                      <input id="fancy-file-upload" type="file" name="image" accept=".jpg, .png, image/jpeg, image/png">
                    </div>
                    <div class="mb-4">  
                      <h5 class="mb-3">Product Status</h5>
                      <div class="form-check form-check-inline">
									<input class="form-check-input" name="status" type="radio" id="inlineRadio" value="1">
									<label class="form-check-label" for="inlineCheckbox1">In Stock</label>
								</div>
                <div class="form-check form-check-inline">
									<input class="form-check-input" name="status" type="radio" id="inlineRadio" value="0">
